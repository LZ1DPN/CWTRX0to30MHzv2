...
unsigned long IF_FREQ = 20000000L;	//default for 7 mhz
unsigned long IF_USB = 20000000L;
unsigned long IF_LSB = 20000000L;
unsigned long IF_CW = 20000000L;  // center freq +100 Hz
...
//  setBandswitch();
	...
	if (frequency >= 30000000){frequency=30000000;}; // UPPER VFO LIMIT
	if (frequency <= 1600000){frequency=1600000;}; // LOWER VFO LIMIT
