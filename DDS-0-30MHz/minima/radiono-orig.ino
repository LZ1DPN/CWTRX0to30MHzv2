...
//#define IF_FREQ   (19997000l) //this is for usb, we should probably have the USB and LSB frequencies separately 19999400
#define IF_FREQ   (9994500l) //this is for usb, we should probably have the USB and LSB frequencies separately 19999400
...
unsigned long vfoA=7000000L, vfoB=14200000L, ritA, ritB;
